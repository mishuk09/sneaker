    ...
    return (
        <>
            <div className="relative">
                {/* Cart Panel */}
                <div
                    className={`fixed top-0 right-0 w-[500px] h-full bg-white shadow-lg transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'} z-50 flex flex-col`}
                >
